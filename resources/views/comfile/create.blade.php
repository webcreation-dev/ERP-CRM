    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-info">
                <div class="panel-heading"> <b> Nouvelle fiche de prospection </b> &nbsp; &nbsp; | &nbsp;<small>(*)
                        Obligatoire</small> </div>

                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('comfiles.store')}}"
                        ...
                        <div class=" row form-group {{ $errors->has('com_date') ? ' has-error' : '' }}">
                            <label for="com_date" class="col-md-3 control-label">DATE DE PROSPECTION <span
                                    class="error">* </span></label>
                            <div class="col-md-8">
                                <input id="com_date" type="date" class="form-control form-control-sm" name="com_date"
                                    value="{{ old('com_date') }}" required>
                        ...
                        <div class=" row form-group {{ $errors->has('categid') ? ' has-error' : '' }}">
                            <label for="category" class="col-md-3 control-label">TYPE CLIENT <span
                                    class="error">*</span></label>
                            <div class="col-md-8">

                                <select onchange="suggestProductReference(this.id)" required="required" name="category"
                                    id="category" class="form-control form-control-sm single-select2">
                                    <option value=""></option>
                        ...
                        <div class="row form-group {{ $errors->has('enterprise') ? ' has-error' : '' }} row">
                            ...
                            <label for="enterprise" class="col-md-3 control-label">NOM DE L'ENTREPRISE<span
                                    class="error"> *</span></label>
                            <div class="col-md-8">
                                <input id="enterprise" type="text" class="form-control form-control-sm"
                                    name="enterprise" value="{{ old('enterprise') }}" required>
                        ...
                        <div class=" row form-group {{ $errors->has('ifu') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input onkeypress="return numbersonly(event)" id="ifu" type="text"
                                    class="form-control form-control-sm" name="ifu" value="{{old('ifu')}}">
                        ...
                        <div class="row form-group {{ $errors->has('phones') ? ' has-error' : '' }} row">
                            ...
                            <label for="phones" class="col-md-3 control-label">TELEPHONES DE L'ENTREPRISE<span
                                    class="error"> *</span></label>
                            <div class="col-md-8">
                                <input id="phones" type="text" class="form-control form-control-sm" name="phones"
                                    value="{{ old('phones') }}" required>
                        ...
                        <div class="row form-group {{ $errors->has('address') ? ' has-error' : '' }} row">
                            ...
                            <label for="address" class="col-md-3 control-label">ADRESSE DE L'ENTREPRISE<span
                                    class="error"> *</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row form-group {{ $errors->has('activity') ? ' has-error' : '' }} row">
                            ...
                            <label for="activity" class="col-md-3 control-label">SECTEUR D'ACTIVITE <span class="error">
                                    *</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row form-group {{ $errors->has('rpt_fullname') ? ' has-error' : '' }} row">
                            ...
                            <label for="rpt_fullname" class="col-md-3 control-label">NOM COMPLET DU REPRESENTANT<span
                                    class="error"> *</span></label>
                            <div class="col-md-8">
                                <input name="rpt_fullname" class="form-control form-control-sm"
                                    value="{{ old('rpt_fullname') }}" />
                        ...
                        <div class="row form-group {{ $errors->has('rpt_phone') ? ' has-error' : '' }} row">
                            ...
                            <label for="rpt_phone" class="col-md-3 control-label">TELEPHONE DU REPRESENTANT<span
                                    class="error"> *</span></label>
                            <div class="col-md-8">
                                <input id="rpt_phone" type="text" class="form-control form-control-sm" name="rpt_phone"
                                    value="{{ old('rpt_phone') }}" required>
                        ...
                        <div class="row form-group {{ $errors->has('enterprise') ? ' has-error' : '' }} row">
                            <label for="discussion" class="col-md-3 control-label">SUJETS DISCUTES <span class="error">
                                    *</span></label>
                            <div class="col-md-8">
                                <textarea required name="discussion"
                                    class="form-control form-control-sm"> {{ old('address') }} </textarea>
                        ...
                        <div class=" row form-group {{ $errors->has('level') ? ' has-error' : '' }}">
                            <label for="result" class="col-md-3 control-label">CONCLUSION <span
                                    class="error">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class=" row form-group {{ $errors->has('next') ? ' has-error' : '' }}">
                            <label for="next" class="col-md-3 control-label">QUELLE EST LA SUITE ? <span
                                    class="error">*</span></label>
                            <div class="col-md-8">

                                <textarea required name="next"
                                    class="form-control form-control-sm"> {{ old('next') }} </textarea>
