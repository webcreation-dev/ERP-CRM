    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">Ajouter une Structure  </div>
                <center class="error">(*) Obligatoire</center>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST"  action="{{ route('groups.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                     ...
                     <div class="form-group form-group-sm {{ $errors->has('identification') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group form-group-sm {{ $errors->has('phones') ? ' has-error' : '' }}">
                            <label for="phones" class="col-md-3 control-label">whatsapp <span class="error">* </span></label>
                            <div class="col-md-8">
                                <input id="phones" type="text" class="form-control" name="phones" value="{{ old('phones') }}">
                         ...
                         <div class="form-group form-group-sm {{ $errors->has('momoNumber') ? ' has-error' : '' }}">
                            <label for="phones" class="col-md-3 control-label">N° MTN Money <span class="error"> </span></label>
                            <div class="col-md-8">
                                <input id="phones" type="text" class="form-control" name="momoNumber" value="{{ old('momoNumber') }}">
                         ...
                         <div class="form-group form-group-sm {{ $errors->has('floozNumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="floozNumber" type="text" class="form-control" name="floozNumber" value="{{ old('floozNumber') }}">
                         ...
                         <div class="form-group form-group-sm {{ $errors->has('bankAccount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="bankAccount" type="text" class="form-control" name="bankAccount" value="{{ old('phones') }}">
                        ...
                        <div class="form-group form-group-sm {{ $errors->has('localisation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="localisation" type="text" class="form-control" name="localisation" value="{{ old('localisation') }}">
                        ...
                        <div class="form-group form-group-sm {{ $errors->has('service') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                               <textarea name="service" class="form-control">{{ old('service') }}</textarea>
                        ...
                        <div class="form-group form-group-sm {{ $errors->has('manager') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="manager" type="text" class="form-control" name="manager" value="{{ old('manager') }}">
                        ...
                        <div class="form-group form-group-sm {{ $errors->has('createDate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="createDate" type="text" class="form-control" name="createDate" value="{{ old('createDate') }}">
